...
function Menu({
  ...
  className,
  ...props
}: React.ComponentPropsWithoutRef<typeof HeadlessMenu>) {
  return (
    <HeadlessMenu
      as="div"
...
Menu.Items = ({
  ...
  ...props
}: React.ComponentPropsWithoutRef<typeof HeadlessMenu.Items> & {
  placement?:
    | "top-start"
    | "top"
    | "top-end"
...
Menu.Item = ({
  ...
  className,
  ...props
}: React.ComponentPropsWithoutRef<typeof HeadlessMenu.Item>) => {
  return (
    <HeadlessMenu.Item
      as="a"
      className={twMerge([
