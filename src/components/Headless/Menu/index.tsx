...
const Menu = ({
                  ...
                  className,
                  ...props
              }: PropsWithChildren<ComponentProps<typeof HeadlessMenu>>) => {
    return (
        <HeadlessMenu
            as="div"
...
export const MenuButton = <C extends React.ElementType = "div">({
                                                                    ...
                                                                    className,
                                                                    ...props
                                                                }: PropsWithChildren<ComponentProps<typeof HeadlessMenu.Button>> & {
    as?: C;
...
export const MenuItems = ({
                              ...
                              ...props
                          }: PropsWithChildren<ComponentProps<typeof HeadlessMenu.Items>> & {
    placement?:
        | "top-start"
        | "top"
        | "top-end"
...
export const MenuItem = ({
                             ...
                             className,
                             ...props
                         }: PropsWithChildren<ComponentProps<typeof HeadlessMenu.Item>>) => {
    return (
        <HeadlessMenu.Item
            as="a"
            className={twMerge([
